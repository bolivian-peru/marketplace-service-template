...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/google/discover', description: 'Google Discover Feed Intelligence API - Get trending content from Google Discover as seen on real mobile devices', price: '0.02 USDC' },
