...
app.get('/health', (c) => c.json({
  ...
  endpoints: [
    ...
    '/api/trending',
    '/api/intel',
    '/api/intel/twitter/:username',
    '/api/intel/reddit/user/:username',
    '/api/intel/trending',
  ],
}));
...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/intel', description: 'Social Intel — aggregated Twitter/X + Reddit with sentiment analysis', price: '0.005 USDC' },
    { method: 'GET', path: '/api/intel/twitter/:username', description: 'Twitter/X profile intelligence with engagement metrics', price: '0.005 USDC' },
    { method: 'GET', path: '/api/intel/reddit/user/:username', description: 'Reddit user profile analysis', price: '0.005 USDC' },
    { method: 'GET', path: '/api/intel/trending', description: 'Trending topics with sentiment analysis', price: '0.01 USDC' },
  ],
  pricing: {
