...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/amazon/product/:asin', description: 'Amazon Product & BSR Tracker — price, BSR, reviews, rating, buy box, availability', price: '0.005 USDC' },
    { method: 'GET', path: '/api/amazon/search', description: 'Amazon keyword search with price/rating/review extraction', price: '0.01 USDC' },
    { method: 'GET', path: '/api/amazon/bestsellers', description: 'Amazon category bestsellers / BSR tracker', price: '0.01 USDC' },
    { method: 'GET', path: '/api/amazon/reviews/:asin', description: 'Amazon rating/review summary by ASIN', price: '0.02 USDC' },
    { method: 'GET', path: '/api/food/search', description: 'Food delivery restaurant search by query/address/platform', price: '0.01 USDC' },
    { method: 'GET', path: '/api/food/restaurant/:id', description: 'Food delivery restaurant details: rating, fees, ETA, promotions', price: '0.01 USDC' },
    { method: 'GET', path: '/api/food/menu/:restaurant_id', description: 'Food delivery menu extraction with item prices', price: '0.02 USDC' },
    { method: 'GET', path: '/api/food/compare', description: 'Cross-platform food delivery price comparison', price: '0.03 USDC' },
    { method: 'GET', path: '/api/tiktok', description: 'TikTok Trend Intelligence — trending, hashtag, creator, and sound data', price: '0.02 USDC' },
