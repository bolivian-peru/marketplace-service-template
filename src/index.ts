...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/food/search', description: 'Search restaurants on Uber Eats, DoorDash, Grubhub with ratings, delivery fees, promotions', price: '0.01 USDC' },
    { method: 'GET', path: '/api/food/restaurant/:id', description: 'Restaurant details: rating, delivery fee, delivery time, minimum order', price: '0.01 USDC' },
    { method: 'GET', path: '/api/food/menu/:restaurant_id', description: 'Full menu extraction with prices, descriptions, customizations', price: '0.02 USDC' },
    { method: 'GET', path: '/api/food/compare', description: 'Cross-platform price comparison across Uber Eats, DoorDash, Grubhub', price: '0.03 USDC' },
