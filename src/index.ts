...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/linkedin/person', description: 'LinkedIn person enrichment (headline, company, skills, location)', price: '0.03 USDC' },
    { method: 'GET', path: '/api/linkedin/company', description: 'LinkedIn company enrichment (industry, employee count, growth, tech signals)', price: '0.05 USDC' },
    { method: 'GET', path: '/api/linkedin/search/people', description: 'LinkedIn people search by title/location/industry (up to 10)', price: '0.10 USDC' },
    { method: 'GET', path: '/api/linkedin/company/:id/employees', description: 'Find company employees by title filter (up to 10)', price: '0.10 USDC' },
