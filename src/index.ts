...
app.get('/health', (c) => c.json({
  ...
  endpoints: [
    ...
    '/api/amazon/search',
    '/api/amazon/bsr/:asin',
    '/api/amazon/prices/:asin',
    '/api/amazon/sentiment/:asin',
  ],
}));
...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/amazon/search', description: 'Search Amazon products by keyword with pricing, ratings, Prime status', price: '0.01 USDC' },
    { method: 'GET', path: '/api/amazon/bsr/:asin', description: 'Track Best Sellers Rank (BSR) by ASIN with category rankings', price: '0.01 USDC' },
    { method: 'GET', path: '/api/amazon/prices/:asin', description: 'Compare prices across sellers — buy box, new, used offers', price: '0.01 USDC' },
    { method: 'GET', path: '/api/amazon/sentiment/:asin', description: 'Review sentiment analysis with rating breakdown and themes', price: '0.01 USDC' },
  ],
  pricing: {
