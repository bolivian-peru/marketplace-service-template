...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/food/search', description: 'Food Delivery Price Intelligence search', price: '0.01 USDC' },
    { method: 'GET', path: '/api/food/restaurant/:id', description: 'Food Delivery restaurant details', price: '0.01 USDC' },
    { method: 'GET', path: '/api/food/menu/:restaurant_id', description: 'Food Delivery menu extraction', price: '0.01 USDC' },
    { method: 'GET', path: '/api/food/compare', description: 'Cross-platform food delivery comparison', price: '0.03 USDC' },
