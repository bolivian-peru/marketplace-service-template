...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/predictions/signal', description: 'Prediction market signal — aggregated odds + social sentiment + trading signals', price: '0.05 USDC' },
    { method: 'GET', path: '/api/predictions/arbitrage', description: 'Cross-platform arbitrage scanner (Polymarket vs Kalshi)', price: '0.03 USDC' },
    { method: 'GET', path: '/api/predictions/sentiment', description: 'Social sentiment analysis for prediction market topics', price: '0.02 USDC' },
    { method: 'GET', path: '/api/predictions/trending', description: 'Trending prediction markets with divergence signals', price: '0.01 USDC' },
  ],
  pricing: {
