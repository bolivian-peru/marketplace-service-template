...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/linkedin/enrich', description: 'Enrich company data from LinkedIn: employee count, industry, etc.', price: '0.01 USDC' },
    ...
    { method: 'GET', path: '/api/facebook/marketplace', description: 'Scrape Facebook Marketplace listings', price: '0.01 USDC' },
