...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/scrape', description: 'Google SERP + AI Overview Scraper — Organic results, featured snippets, People Also Ask, AI Overviews', price: '0.003 USDC' },
