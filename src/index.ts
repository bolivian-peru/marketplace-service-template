...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/x/search', description: 'X/Twitter real-time tweet search with full engagement metrics', price: '0.01 USDC' },
    { method: 'GET', path: '/api/x/trending', description: 'X/Twitter trending topics by country', price: '0.005 USDC' },
    { method: 'GET', path: '/api/x/user/:handle', description: 'X/Twitter user profile data', price: '0.01 USDC' },
    { method: 'GET', path: '/api/x/user/:handle/tweets', description: 'Recent tweets from an X/Twitter user', price: '0.01 USDC' },
    { method: 'GET', path: '/api/x/thread/:tweet_id', description: 'Full tweet thread/conversation with replies', price: '0.02 USDC' },
  ],
  pricing: {
