...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/realestate/property/:zpid', description: 'Zillow Property Details', price: '0.02 USDC' },
    { method: 'GET', path: '/api/realestate/search', description: 'Zillow Search by address, ZIP, city', price: '0.01 USDC' },
    { method: 'GET', path: '/api/realestate/market', description: 'Zillow Market Report by ZIP', price: '0.05 USDC' },
    { method: 'GET', path: '/api/realestate/comps/:zpid', description: 'Zillow Comparable Sales', price: '0.03 USDC' },
  ],
  pricing: {
