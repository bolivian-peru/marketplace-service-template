...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/ads/search', description: 'Mobile ad verification — search ads by query + country', price: '0.03 USDC' },
    { method: 'GET', path: '/api/ads/display', description: 'Display ad detection — scan any URL for ads + networks', price: '0.03 USDC' },
    { method: 'GET', path: '/api/ads/advertiser', description: 'Advertiser intelligence — ad activity + transparency data', price: '0.05 USDC' },
  ],
  pricing: {
