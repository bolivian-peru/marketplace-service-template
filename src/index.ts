...
app.get('/health', (c) => c.json({
  ...
  endpoints: ['/api/jobs', '/api/reviews/search', '/api/reviews/:place_id', '/api/reviews/summary/:place_id', '/api/business/:place_id', '/api/amazon/product/:asin', '/api/amazon/search', '/api/amazon/bestsellers', '/api/amazon/reviews/:asin'],
}));
...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/amazon/product/:asin', description: 'Get Amazon product data: price, BSR, rating, buy box, availability', price: '0.005 USDC' },
    { method: 'GET', path: '/api/amazon/search', description: 'Search Amazon products by keyword with category filter', price: '0.01 USDC' },
    { method: 'GET', path: '/api/amazon/bestsellers', description: 'Get Amazon bestseller rankings by category', price: '0.01 USDC' },
    { method: 'GET', path: '/api/amazon/reviews/:asin', description: 'Fetch Amazon product reviews by ASIN', price: '0.02 USDC' },
  ],
  pricing: {
...
app.notFound((c) => c.json({ error: 'Not found', endpoints: ['/', '/health', '/api/jobs', '/api/reviews/search', '/api/reviews/:place_id', '/api/business/:place_id', '/api/reviews/summary/:place_id', '/api/amazon/product/:asin', '/api/amazon/search', '/api/amazon/bestsellers', '/api/amazon/reviews/:asin'] }, 404));
