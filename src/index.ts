...
app.get('/health', (c) => c.json({
  ...
  endpoints: [
    ...
    '/api/trending',
    '/api/zillow/search',
    '/api/zillow/property/:zpid',
    '/api/zillow/zestimate/:zpid',
    '/api/zillow/comps/:zpid',
    '/api/zillow/market-trends',
    '/api/zillow/neighborhood',
  ],
}));
...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/zillow/search', description: 'Search Zillow property listings by location/price/type', price: '0.02 USDC' },
    { method: 'GET', path: '/api/zillow/property/:zpid', description: 'Get detailed property listing with features and history', price: '0.01 USDC' },
    { method: 'GET', path: '/api/zillow/zestimate/:zpid', description: 'Get Zestimate valuation with value range and trends', price: '0.01 USDC' },
    { method: 'GET', path: '/api/zillow/comps/:zpid', description: 'Get comparable properties with similarity scores', price: '0.02 USDC' },
    { method: 'GET', path: '/api/zillow/market-trends', description: 'Real estate market trends and price analysis', price: '0.05 USDC' },
    { method: 'GET', path: '/api/zillow/neighborhood', description: 'Neighborhood stats: walkability, schools, demographics', price: '0.03 USDC' },
  ],
  pricing: {
