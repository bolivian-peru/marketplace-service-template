...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/tiktok/hashtag', description: 'TikTok hashtag analytics — views, growth, top videos', price: '0.02 USDC' },
    { method: 'GET', path: '/api/tiktok/creator', description: 'TikTok creator profile — followers, engagement, recent posts', price: '0.02 USDC' },
    { method: 'GET', path: '/api/tiktok/sound', description: 'TikTok sound/audio trend intelligence', price: '0.02 USDC' },
  ],
  pricing: {
