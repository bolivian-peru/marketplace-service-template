...
app.get('/health', (c) => c.json({
  ...
  endpoints: ['/api/run', '/api/details', '/api/jobs', '/api/research', '/api/trending', '/api/reviews/search', '/api/reviews/:place_id', '/api/reviews/summary/:place_id', '/api/business/:place_id', '/api/zillow/property/:zpid', '/api/zillow/search', '/api/zillow/comps/:zpid', '/api/zillow/market'],
}));
...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/zillow/property/:zpid', description: 'Full Zillow property: price, Zestimate, history, neighborhood', price: '0.02 USDC' },
    { method: 'GET', path: '/api/zillow/search', description: 'Search Zillow by address, ZIP, or city with filters', price: '0.01 USDC' },
    { method: 'GET', path: '/api/zillow/comps/:zpid', description: 'Comparable sales with distance and similarity', price: '0.03 USDC' },
    { method: 'GET', path: '/api/zillow/market', description: 'ZIP-level market stats: median value, rent, inventory', price: '0.05 USDC' },
  ],
  pricing: {
...
app.notFound((c) => c.json({ error: 'Not found', endpoints: ['/', '/health', '/api/run', '/api/details', '/api/jobs', '/api/reviews/search', '/api/reviews/:place_id', '/api/business/:place_id', '/api/reviews/summary/:place_id', '/api/zillow/property/:zpid', '/api/zillow/search', '/api/zillow/comps/:zpid', '/api/zillow/market'] }, 404));
