...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/price', description: 'E-commerce price tracker — current price, history, discounts', price: '0.005 USDC' },
    { method: 'GET', path: '/api/price/history', description: 'Get price history for a product', price: '0.005 USDC' },
    { method: 'POST', path: '/api/price/alert', description: 'Set price drop alert', price: '0.005 USDC' },
    { method: 'GET', path: '/api/price/alerts', description: 'Get price alerts for a product', price: '0.005 USDC' },
    { method: 'DELETE', path: '/api/price/alert', description: 'Delete a price alert', price: '0.005 USDC' },
  ],
  pricing: {
